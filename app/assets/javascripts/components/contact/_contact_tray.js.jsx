		    ...
		    <Grid>
		    	<Row>
		    		<Col xs={6} md={6}>
				    	...
				    	<a href="https://reverb.com/shop/chicagoelectricpiano"><img src="https://github.com/Jfrederick12/Chicago_Electric_Piano_Site/blob/blog-markdown/app/assets/images/image.png?raw=true" width="15%"/></a>
			    	</Col>
			    	<Col xs={6} md={6}>
			    	  < ReactForm />
			    	</Col>
